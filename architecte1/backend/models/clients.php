...
public $RDV;
  ...
  {
    // Create query
    $query = 'INSERT INTO ' . $this->table . ' SET nom = :nom, prenom = :prenom, date_naissance = :date_naissance, situation_familiale = :situation_familiale,  adress= :adress, date_depart = :date_depart, date_darrive = :date_darrive, type_pass = :type_pass, num_pass = :num_pass, nationalite = :nationalite, type_visa = :type_visa,reff = :reff';
    ...
    $stmt->bindParam(':ate_depart', $this->ate_depart);
  ...
  public function update()
  {
    ...
    $query = 'UPDATE ' . $this->table . '
          SET nom = :nom, prenom = :prenom, date_naissance = :date_naissance, situation_familiale = :situation_familiale,  adress= :adress, date_depart = :date_depart, date_darrive = :date_darrive, type_pass = :type_pass, num_pass = :num_pass, nationalite = :nationalite, type_visa = :type_visa,reff = :reff
                                WHERE id = :id';
