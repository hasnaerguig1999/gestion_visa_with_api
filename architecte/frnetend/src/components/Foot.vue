<template>
    ...
    <div class="footer_container">
        ...
        <div class="botton_footer_info">
            <p>Created by : Hasnae Rguig</p>
        </div>
    </div>
</footer> -->
     <footer class="bg-success text-center text-lg-start">
  <!-- Copyright -->
  <div class="text-center p-5 text-light" style="background-color: rgba(0, 0, 0, 0.36);">
    © 2023 Copyright:
    <a class="text-light" href="https://mdbootstrap.com/">Visa.com</a>
  </div>
  <!-- Copyright -->
</footer>
</template>
